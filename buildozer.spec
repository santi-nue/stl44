...
requirements = python==3.9.4,kivy==2.1.0,cachetools,pyasn1-modules,pyasn1,rsa,six,urllib3,openssl, futures, requests,charset-normalizer,idna,docutils,Kivy-Garden,kivy-garden.mapview,httplib2,jnius,textwrap3
